...
- Includes access-mode-gated tool catalogs, bounded tool arguments, idempotency headers, sanitized MCP resources, reusable MCP prompts, and API error redaction.
